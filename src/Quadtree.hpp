...
private:
    ...
    atomic<int> nodeCounter;     // For limiting node count
    atomic<bool> timeoutFlag;    // For early termination
    int maxDepth;                // Variable to control max depth
    
    // Variables for low compression control
    bool forceLowCompression;
    double targetNodeRatio; // 1.0 means no compression
    mt19937 rng;            // Random number generator
    
    // Variables for fixed-grid and hybrid approach
    ...
    // Extract ROI safely with boundary checking
